    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-actions">
                <a href="/de/qualities/" class="btn btn-primary">{% include t.html key="explore_qualities" %}</a>
                <a href="/de/about/" class="btn btn-secondary">{% include t.html key="about" %}</a>
            </div>
        </div>
    </section>
    ...
    <section class="quality-overview">
        <div class="container">
            ...
            <div class="qualities-grid">
                ...
                <a href="/de/{{ quality.slug }}/" class="quality-card" data-quality="{{ quality.slug }}">
